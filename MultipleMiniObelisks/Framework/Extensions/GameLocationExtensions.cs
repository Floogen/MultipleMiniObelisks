...
namespace MultipleMiniObelisks.MultipleMiniObelisks.Extensions
{
    public static class GameLocationExtensions
    {
        public static bool isTileOccupiedForPlacement(this GameLocation location, Vector2 tileLocation, StardewValley.Object toPlace = null)
        {
